						...
						<div class="navbar-nav mr-auto py-0">
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="s-register.jsp" class="dropdown-item">As Seller</a> <a
										href="c-register.jsp" class="dropdown-item">As Customer</a>
								</div>
							</div>
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									...
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="s-login.jsp" class="dropdown-item">As Seller</a> <a
										href="c-login.jsp" class="dropdown-item">As Customer</a> <a
										href="a-login.jsp" class="dropdown-item">As Admin</a>
								</div>
							</div>
						</div>
