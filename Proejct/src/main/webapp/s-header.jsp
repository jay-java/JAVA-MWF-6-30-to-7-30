				...
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="s-home.jsp" class="nav-item nav-link active">Home</a> 
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									data-toggle="dropdown">Product <i
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="s-upload-product.jsp" class="dropdown-item">Upload Product</a>
									<a href="s-manage-product.jsp" class="dropdown-item">Manage Product</a>
								</div>
							</div>
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									...
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="s-profile.jsp" class="dropdown-item">Profile</a> <a
										href="s-change-password.jsp" class="dropdown-item">Change Password</a> <a
										href="s-logout.jsp" class="dropdown-item">Logout</a>
								</div>
							</div>
						</div>
